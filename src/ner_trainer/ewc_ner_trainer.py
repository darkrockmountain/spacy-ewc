...
def train_ner_with_ewc(ner, examples, ewc,
                       *,
                       drop=0.,
                       sgd=None,
                       losses=None):
...
def train_nlp_with_ewc(nlp, examples, ewc,
                       *,
                       drop=0.,
                       sgd=None,
                       losses=None):
    ...
    """
    return train_ner_with_ewc(ner=nlp.get_pipe("ner"), examples=examples, ewc=ewc, drop=drop, sgd=sgd, losses=losses)
