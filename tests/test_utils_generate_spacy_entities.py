...
class TestGenerateSpacyEntities(unittest.TestCase):
    ...
    def test_basic_functionality(self):
        sentences = ["John bought a new car yesterday.", "Microsoft announced new software in San Francisco."]
        expected_output = [
            ("John bought a new car yesterday.", {"entities": [(0, 4, "PERSON"), (22, 31, "DATE")]}),
            ("Microsoft announced new software in San Francisco.", {"entities": [(0, 9, "ORG"), (36, 49, "GPE")]})
        ]
    ...
    def test_sentence_with_overlapping_entities(self):
        # Testing with an entity pattern that might overlap (e.g., both "John" and "John Smith" as separate entities)
        sentences = ["John Smith went to San Francisco."]
        # Expected to catch "John" as PERSON and "San Francisco" as GPE based on the test setup
        expected_output = [("John Smith went to San Francisco.", {"entities": [(0, 4, "PERSON"), (19, 32, "GPE")]})]
        result = generate_spacy_entities(sentences, self.nlp)
        self.assertEqual(result, expected_output)

    def test_sentence_with_special_characters(self):
        sentences = ["John bought @ new car yesterday!"]
        expected_output = [("John bought @ new car yesterday!", {"entities": [(0, 4, "PERSON"), (22, 31, "DATE")]})]
        result = generate_spacy_entities(sentences, self.nlp)
        self.assertEqual(result, expected_output)
    ...
    def test_mixed_entity_types(self):
        ...
        expected_output = [
            ("John visited Microsoft headquarters in San Francisco yesterday.",
             {"entities": [(0, 4, "PERSON"), (13, 22, "ORG"), (39, 52, "GPE"), (53, 62, "DATE")]})
        ]
        result = generate_spacy_entities(sentences, self.nlp)
        self.assertEqual(result, expected_output)
    ...
    def test_non_string_input(self):
        ...
        # Only valid string sentences should return entities, others should either be ignored or raise an error
