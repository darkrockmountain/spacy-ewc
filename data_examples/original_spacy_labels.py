...
original_spacy_labels = [
    ...
    ('Sarah earned $500 in tips last week.', {'entities': [
        (0, 5, 'PERSON'), (14, 17, 'MONEY'), (26, 35, 'DATE')]}),
    ...
    ('Tom visited Paris in July.', {'entities': [
        (0, 3, 'PERSON'), (12, 17, 'GPE'), (21, 25, 'DATE')]}),
    ...
    ('Mia went to the gym at 6:00 a.m. today.', {'entities': [
        (0, 3, 'PERSON'), (23, 32, 'TIME'), (33, 38, 'DATE')]}),
    ('The bank charged a fee of $25 for the transfer.',
     {'entities': [(27, 29, 'MONEY')]}),
    ('The wedding is set for October 10th.',
     {'entities': [(23, 35, 'DATE')]}),
    ...
    ('The train leaves at 9:45 a.m. sharp.',
     {'entities': [(20, 29, 'TIME')]}),
    ('Lucas and Emma traveled to Germany in spring.', {'entities': [
        (0, 5, 'ORG'), (10, 14, 'PERSON'), (27, 34, 'GPE'), (38, 44, 'DATE')]}),
    ('The ticket costs $12 for adults.',
     {'entities': [(18, 20, 'MONEY')]}),
    ...
    ('The cafe charges $3 for a coffee.',
     {'entities': [(18, 19, 'MONEY')]}),
    ('His flight departs at 11:00 a.m.',
     {'entities': [(22, 32, 'TIME')]}),
    ('The meeting starts at 10:00 on Thursday.',
     {'entities': [(22, 39, 'TIME')]}),
    ('Zara hired 50 new employees last quarter.', {'entities': [
        (0, 4, 'ORG'), (11, 13, 'CARDINAL'), (28, 40, 'DATE')]}),
    ('She pays $50 for her gym membership monthly.', {
        'entities': [(10, 12, 'MONEY'), (36, 43, 'DATE')]}),
    ('The bank is located on Fifth Avenue.', {
        'entities': [(23, 35, 'FAC')]}),
    ('The marathon is scheduled for October 3rd.',
     {'entities': [(30, 41, 'DATE')]}),
    ('The store is having a sale on April 5th.',
     {'entities': [(30, 39, 'DATE')]}),
    ("Ryan's flight landed at 6:00 a.m. today.", {'entities': [
        (0, 4, 'PERSON'), (24, 33, 'TIME'), (34, 39, 'DATE')]}),
    ('The zoo opens at 10:00 a.m. on weekends.',
     {'entities': [(17, 27, 'TIME')]}),
    ('His car was towed for $200.', {
        'entities': [(23, 26, 'MONEY')]}),
    ('The theater has a show at 7:30 p.m. daily.',
     {'entities': [(26, 41, 'TIME')]}),
    ('Anna works at the United Nations.', {
        'entities': [(0, 4, 'PERSON'), (14, 32, 'FAC')]}),
    ('They sold their house for $450,000.',
     {'entities': [(27, 34, 'MONEY')]}),
    ...
    ('Her salary was increased by $5,000.',
     {'entities': [(29, 34, 'MONEY')]}),
    ...
    ('His flight arrives at noon.', {
        'entities': [(22, 26, 'TIME')]}),
    ('Their mortgage is $1,200 per month.',
     {'entities': [(19, 24, 'MONEY')]}),
    ('The show will be in the Broadway Theater.',
     {'entities': [(20, 40, 'ORG')]}),
    ('Her office is on the 20th floor.', {
        'entities': [(21, 25, 'ORDINAL')]}),
    ...
    ('The gala will be hosted by ABC Network.',
     {'entities': [(27, 38, 'ORG')]}),
    ('She spent $75 on a pair of shoes.',
     {'entities': [(11, 13, 'MONEY')]}),
    ...
    ('He works at a hospital in New York City.',
     {'entities': [(26, 39, 'GPE')]}),
    ('They went to dinner at 8:30 p.m.',
     {'entities': [(23, 32, 'TIME')]}),
    ...
    ('The ticket cost $20 per person.',
     {'entities': [(17, 19, 'MONEY')]}),
    ('They attended the ceremony at 5 p.m.',
     {'entities': [(30, 36, 'TIME')]}),
    ('Her favorite restaurant is in Boston.',
     {'entities': [(30, 36, 'GPE')]}),
    ('He paid $15 for the parking fee.',
     {'entities': [(9, 11, 'MONEY')]}),
    ...
    ('The course fee is $500.', {
        'entities': [(19, 22, 'MONEY')]}),
    ('They moved to San Diego last year.', {
        'entities': [(14, 23, 'GPE'), (24, 33, 'DATE')]}),
    ('The lecture will be at the main hall.',
     {'entities': []}),
    ('Her birthday is on December 25th.',
     {'entities': [(19, 32, 'DATE')]}),
    ('The plane landed at 7:30 p.m.', {
        'entities': [(20, 29, 'TIME')]}),
    ('They bought a laptop for $1,200.',
     {'entities': [(26, 31, 'MONEY')]}),
    ('The game begins at 7 p.m.', {
        'entities': [(19, 25, 'TIME')]}),
    ('They plan to visit the museum on June 20.',
     {'entities': [(33, 40, 'DATE')]}),
    ('The car cost him $25,000.', {
        'entities': [(18, 24, 'MONEY')]}),
    ('Her office is on the 5th Avenue.',
     {'entities': [(21, 31, 'FAC')]}),
    ('The graduation is scheduled for May 5th.',
     {'entities': [(32, 39, 'DATE')]}),
    ('He works for the United States Postal Service.',
     {'entities': [(13, 45, 'ORG')]}),
    ('Their wedding was in Las Vegas.',
     {'entities': [(21, 30, 'GPE')]}),
    ('The class begins at 11:00 a.m.',
     {'entities': [(20, 30, 'TIME')]}),
    ('They received a grant of $10,000.',
     {'entities': [(26, 32, 'MONEY')]}),
    ('Her appointment is at noon.', {
        'entities': [(22, 26, 'TIME')]}),
    ('They donated $100 to the food bank.',
     {'entities': [(14, 17, 'MONEY')]}),
    ('The store is on the second floor.',
     {'entities': [(20, 26, 'ORDINAL')]}),
    ('The parade is on the first Saturday in June.', {
        'entities': [(21, 26, 'ORDINAL'), (27, 35, 'DATE'), (39, 43, 'DATE')]}),
    ...
    ('The shop charges $10 for shipping.',
     {'entities': [(18, 20, 'MONEY')]}),
    ('They will visit the park on Saturday.',
     {'entities': [(28, 36, 'DATE')]}),
    ('The concert costs $50 per ticket.',
     {'entities': [(19, 21, 'MONEY')]}),
    ...
    ('eBay hosts auctions for rare antiques from England, often attracting over 100,000 visitors daily to bid online.', {
     'entities': [(0, 4, 'ORG'), (43, 50, 'GPE'), (74, 81, 'CARDINAL'), (91, 96, 'DATE')]}),
    ...
    ('LinkedIn is widely used by professionals like Sarah Johnson, a software engineer in San Francisco, to connect with companies like Google and Microsoft.', {
     'entities': [(0, 8, 'ORG'), (46, 59, 'PERSON'), (84, 97, 'GPE'), (130, 136, 'ORG'), (141, 150, 'ORG')]}),
    ('HarperCollins released a new novel by Margaret Atwood in September, which was quickly sold out in bookstores across Canada.', {
     'entities': [(38, 53, 'PERSON'), (57, 66, 'DATE'), (116, 122, 'GPE')]}),
    ("BioWare's latest game, Dragon Age: Origins, was developed in collaboration with artists in Tokyo and launched at Comic-Con in San Diego.",
     {'entities': [(0, 7, 'ORG'), (23, 42, 'WORK_OF_ART'), (91, 96, 'GPE'), (113, 122, 'PERSON'), (126, 135, 'GPE')]}),
]
