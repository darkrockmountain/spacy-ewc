...
original_spacy_labels = [('John bought a new car yesterday.', {'entities': [(0, 4, 'PERSON'), (22, 31, 'DATE')]}),
                         ...
                         ('Zara hired 50 new employees last quarter.', {'entities': [
                             (0, 4, 'PERSON'), (11, 13, 'CARDINAL'), (28, 40, 'DATE')]}),
                         ...
                         ('Her job is located in downtown Denver.',
                          {'entities': [(31, 37, 'GPE')]}),
                         ('The lab opens at 6 a.m. every weekday.', {'entities': [(17, 23, 'TIME')]}),]
