...
class TestExtractLabels(unittest.TestCase):
    ...
    def test_empty_entities_list(self):
        ...
        data = [
            ('A sentence with empty entities list.', {'entities': []})
        ]
        expected_labels = set()
        result = extract_labels(data)
        self.assertEqual(result, expected_labels)
    ...
    def test_multiple_occurrences_of_same_label(self):
        ...
        data = [
            ('Alice met Bob in New York.', {'entities': [(0, 5, 'PERSON'), (9, 12, 'PERSON'), (16, 24, 'GPE')]}),
            ('Bob moved to New York.', {'entities': [(0, 3, 'PERSON'), (14, 22, 'GPE')]})
        ]
    ...
    def test_mixed_labels(self):
        ...
        data = [
            ('A complex sentence.', {'entities': [(0, 1, 'LOC'), (2, 5, 'TIME'), (6, 10, 'MISC')]}),
            ('Another with overlapping labels.', {'entities': [(1, 4, 'ORG'), (5, 8, 'PRODUCT')]})
        ]
    ...
    def test_single_entity(self):
        ...
        data = [
            ('This has only one entity.', {'entities': [(5, 9, 'EVENT')]})
        ]
    ...
    def test_unexpected_data_format(self):
        ...
        data = [
            {'text': 'This format is unexpected.', 'entities': [(0, 4, 'ORG')]}
        ]
